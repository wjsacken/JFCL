...
var swiper_esm = __webpack_require__(52740);
...
__webpack_require__.d(__webpack_exports__, {
  ...
  "gI": () => (/* reexport */ EffectCreative),
  "xW": () => (/* reexport */ EffectFade),
  "Rv": () => (/* reexport */ freeMode),
  "rj": () => (/* reexport */ Grid),
  "kr": () => (/* reexport */ HashNavigation),
  "Ay": () => (/* reexport */ History),
...
// UNUSED EXPORTS: Controller, EffectCards, EffectCoverflow, EffectCube, EffectFlip, Manipulation, Swiper, Zoom
...
function Virtual({
  ...
  function renderSlide(slide, index) {
    ...
    if (params.renderSlide) {
      ...
      slideEl = utils_createElement('swiper-slide');
    } else {
      slideEl = utils_createElement('div', swiper.params.slideClass);
    }
  ...
  function update(force) {
    ...
    utils_elementChildren(swiper.slidesEl, '.swiper-slide, swiper-slide').forEach(slideEl => {
      slideEl.style[offsetProp] = `${offset - Math.abs(swiper.cssOverflowAdjustment())}px`;
    });
    onRendered();
  }
