        ...
        <section className="mil-banner">
            ...
            >
                ...
                <SwiperSlide className="swiper-slide" key={`hero-one-slider-item-${key}`}>
                    <Image src={item.image} className="mil-bg-img" widht="1300" height="300" alt={item.alt} style={{"objectPosition": "top"}} data-swiper-parallax-x="300" data-swiper-parallax-scale="1.3" />
                </SwiperSlide>
                ))}
            </Swiper>
                        ...
                        <div className="col-xl-7">
                            ...
                            <div className="mil-mb-90">
                                ...
                                <Link href={Data.button.link} className="mil-link mil-light mil-upper">
                                    {Data.button.label} 
                                    <span className="mil-arrow"><Image src="/img/icons/1.svg" alt="arrow" width="20" height="20"/></span>
                                </Link>
                            </div>
