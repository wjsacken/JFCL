                    ...
                    <div className="col-lg-4">
                        ...
                        <div className="mil-mb-90">
                            ...
                            <a href="tel:800-849-5291" className="mil-mb-30">
                                <Image src="/img/icons/phone-call1.svg" alt="call Wallace & Graham" width="20" style={{top:"5px", position:"relative"}}></Image> 800-849-5291
                            </a>
                            <br/>
                            <a href="mailto:JusticeForCampLejeune@wallacegraham.com">
                                <Image src="/img/icons/mail.svg" alt="email Wallace & Graham" style={{top:"5px", position:"relative"}}></Image> Email
                            </a>
                            <h3 className="mil-up mt-xxl-4 mil-mb-10">Rhine Law Firm</h3>
                            <a href="tel:866-772-996" className="mil-mb-30">
                                <Image src="/img/icons/phone-call1.svg" alt="call Rhine" width="20"></Image> 866-772-9960
                            </a><br/>
                            <a href="mailto:attorneys@rhinelawfirm.com">
                                <Image src="/img/icons/mail.svg" alt="email Rhine" style={{top:"5px", position:"relative"}}></Image> Email
                            </a>
